...
<div class="form-group">
    ...
    <select name="kostumer" class="form-control">
        <option value="">-Pilih Kostumer-</option><?php foreach($kostumer as $k){ ?>
...
<div class="form-group">
    ...
    <input type="date" name="tgl_pinjam" class="formcontrol"> <?php echo form_error('tgl_pinjam'); ?>
</div>
<div class="form-group">
    <label>Tanggal Kembali</label>
    <input type="date" name="tgl_kembali" class="formcontrol">
