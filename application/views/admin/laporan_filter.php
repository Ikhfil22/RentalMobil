...
<div class="btn-group">
    ...
    <a class="btn btn-default btn-sm" href="<?php echo base_url().'admin/laporan_print/?dari='.set_value('dari').'&sampai='.set_value('sampai') ?>"><span class="glyphicon glyphiconprint"></span> Print</a>
</div>
<br/>
<br/>
